...
export default function Wallet() {
    ...
    return (
       <div>
        ...
        <Toolbar>
          <Typography variant="h5" noWrap component="div" classNameName='whiteline'>
	...
	<div className="wallet-container text-center">
		...
		<div className="btn-group text-center">
			<button  className="btn btn-outline-light" onClick={()=>history.push("/add/money/"+data.balance)}>Add Money</button>
		</div>
...
:<p classNameName="text-center">No data found</p>
            ...
            <div className="footer-menu">
				<div className="row text-center">
					...
					<div className="col-md-4"onClick={()=>history.push("/user/dashboard")}>
						<i className="fa fa-home"></i>
						<p >Main Menu</p>
					</div>
				</div>
			</div>
			<div className="footer-menu-fix">
			</div>
</div>
<ToastContainer/>
