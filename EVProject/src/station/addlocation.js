...
export default function Addlocation() {
    ...
    function addlocation(){
        ...
        makePostRequest("/update/location", bodyFormData).then((response) => {
...
<center>
       ...
       <div>
       <input className="myInput" placeholder="Copy Your Google Map Location And Paste Here (: " value={selectedFile}  onChange={changeHandler} /> 
       </div>
       <div>
        <br/>
            <button  className="button"  onClick={()=>addlocation()}>
                <span class="button__text">Add Location</span>
                <span class="button__icon"><AddLocationIcon/></span>
            </button>
       </div>
